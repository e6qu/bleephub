...
def render() -> str:
    ...
    out = [
        ...
        "",
        "The list is every module linked into a shipped binary on linux/amd64 and",
        "linux/arm64. Many modules share a licence word for word, so each distinct text is",
        "printed once, in the second part, and a module names the texts that are its own.",
        "",
        "Generated by scripts/generate-third-party-licenses.py; do not edit by hand.",
        "",
        rule,
        f"Part 1: the {len(entries)} modules",
        rule,
        "",
        "\n\n".join(entries),
        "",
        rule,
        f"Part 2: the {len(texts)} texts",
        rule,
    ]
