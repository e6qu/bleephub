...
const routes = [
  ["dashboard", "/ui/"],
  ["repo-home", "/ui/repos/admin/hello-app"],
  ["repo-tree-src", "/ui/repos/admin/hello-app/tree/main/src"],
  ["repo-blob", "/ui/repos/admin/hello-app/blob/main/src/server.go"],
  ["repo-commits", "/ui/repos/admin/hello-app/commits"],
  ["repo-branches", "/ui/repos/admin/hello-app/branches"],
  ["issues-list", "/ui/repos/admin/hello-app/issues"],
  ["issue-detail", "/ui/repos/admin/hello-app/issues/7"],
  ["pulls-list", "/ui/repos/admin/hello-app/pulls"],
  ["pr-detail", "/ui/repos/admin/hello-app/pulls/121"],
  ["pr-files", "/ui/repos/admin/hello-app/pulls/121/files"],
  ["releases", "/ui/repos/admin/hello-app/releases"],
  ["wiki", "/ui/repos/admin/hello-app/wiki"],
  ["repo-insights", "/ui/repos/admin/hello-app/insights"],
  ["repo-actions", "/ui/repos/admin/hello-app/actions"],
  ["repo-settings", "/ui/repos/admin/hello-app/settings"],
