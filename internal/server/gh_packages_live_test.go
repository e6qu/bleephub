...
func TestLivePackages_UserOrgRepo(t *testing.T) {
	...
	cases := []struct {
		...
		{"/ui-data/users/" + admin.Login + "/packages/container/live-user-pkg/versions/" + strconv.Itoa(userVersionID) + "/files"},
		...
		{"/ui-data/orgs/" + org.Login + "/packages/npm/live-org-pkg/versions/" + strconv.Itoa(orgVersionID) + "/files"},
		{"/ui-data/repos/" + repo.FullName + "/packages"},
		{"/ui-data/repos/" + repo.FullName + "/packages/docker/live-repo-pkg"},
		{"/ui-data/repos/" + repo.FullName + "/packages/docker/live-repo-pkg/versions"},
		{"/ui-data/repos/" + repo.FullName + "/packages/docker/live-repo-pkg/versions/" + strconv.Itoa(repoVersionID)},
		{"/ui-data/repos/" + repo.FullName + "/packages/docker/live-repo-pkg/versions/" + strconv.Itoa(repoVersionID) + "/files"},
	}
