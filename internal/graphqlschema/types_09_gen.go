...
func (r *Registry) defineRemoveCloseIssueReferencesInput() {
	r.input("RemoveCloseIssueReferencesInput", "Autogenerated input type of RemoveCloseIssueReferences", func() graphql.InputObjectConfigFieldMap {
		return graphql.InputObjectConfigFieldMap{
			"clientMutationId": {
				Type:        r.t("String"),
				Description: "A unique identifier for the client performing the mutation.",
			...
			"issueId": {
				Type:        graphql.NewNonNull(r.t("ID")),
				Description: "ID of the issue to remove closing references from.",
			},
			"pullRequestIds": {
				Type:        graphql.NewNonNull(graphql.NewList(graphql.NewNonNull(r.t("ID")))),
				Description: "IDs of manually linked pull requests to remove. Auto-detected closing references are left unchanged. Limit: 10.",
			},
		}
	})
}

func (r *Registry) defineRemoveCloseIssueReferencesPayload() {
	r.object("RemoveCloseIssueReferencesPayload", "Autogenerated return type of RemoveCloseIssueReferences.", nil, func() graphql.Fields {
		return graphql.Fields{
			"clientMutationId": {
				Type:        r.t("String"),
				Description: "A unique identifier for the client performing the mutation.",
			...
			"issue": {
				Type:        r.t("Issue"),
				Description: "The issue the closing references were removed from.",
			},
		}
	})
}
