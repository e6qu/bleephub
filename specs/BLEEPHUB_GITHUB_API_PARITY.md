...
- all 1,219 routes produced by the real `/api/v3` runtime registration table, with source locations where a route is literal and an explicit programmatic-registration marker otherwise;
