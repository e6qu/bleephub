	...
	r.object("Mutation", "The root query for implementing GraphQL mutations.", nil, func() graphql.Fields {
		return graphql.Fields{
			...
			"addCloseIssueReferences": {
				Type:        r.t("AddCloseIssueReferencesPayload"),
				Description: "Adds one or more pull requests as manually linked closing references on an\nissue. The target must be an issue, not a pull request.",
				Args: graphql.FieldConfigArgument{
					"input": {
						Type:        graphql.NewNonNull(r.t("AddCloseIssueReferencesInput")),
						Description: "Parameters for AddCloseIssueReferences",
					},
				},
			},
			"addComment": {
			...
			"removeCloseIssueReferences": {
				Type:        r.t("RemoveCloseIssueReferencesPayload"),
				Description: "Removes one or more manually linked pull requests from an issue. Auto-detected\nclosing references from pull request body keywords are not removed; edit the\npull request body instead.",
				Args: graphql.FieldConfigArgument{
					"input": {
						Type:        graphql.NewNonNull(r.t("RemoveCloseIssueReferencesInput")),
						Description: "Parameters for RemoveCloseIssueReferences",
					},
				},
			},
