...
function buildRoutes(): { route: string; label: string }[] {
  ...
  return [
    ...
    { route: "/ui/account?tab=billing", label: "account-billing" },
    { route: "/ui/operations/enterprise", label: "enterprise" },
    ...
    { route: `/ui/orgs/${org}/settings`, label: "org-settings-billing" },
