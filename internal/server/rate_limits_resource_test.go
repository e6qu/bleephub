...
func TestAPIRateResourceDoesNotMatchRepositoryNames(t *testing.T) {
	cases := []struct{ path, want string }{
		...
		{"/api/v3/repos/octo/hello/dependency-graph/sbom", "dependency_sbom"},
		{"/api/v3/repos/octo/hello/dependency-graph/sbom/generate-report", "dependency_sbom"},
		{"/api/v3/enterprises/acme/copilot/usage-records", "copilot_usage_records"},
