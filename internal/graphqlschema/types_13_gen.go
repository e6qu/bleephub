...
func (r *Registry) defineVerifyVerifiableDomainInput() {
	r.input("VerifyVerifiableDomainInput", "Autogenerated input type of VerifyVerifiableDomain", func() graphql.InputObjectConfigFieldMap {
		return graphql.InputObjectConfigFieldMap{
			"clientMutationId": {
				Type:        r.t("String"),
				Description: "A unique identifier for the client performing the mutation.",
...
func (r *Registry) defineVerifyVerifiableDomainPayload() {
	r.object("VerifyVerifiableDomainPayload", "Autogenerated return type of VerifyVerifiableDomain.", nil, func() graphql.Fields {
		return graphql.Fields{
			"clientMutationId": {
				Type:        r.t("String"),
				Description: "A unique identifier for the client performing the mutation.",
